...
async function generateLocalStreamingResponse(message, onStep) {
  ...
  // Como o Gemini está desativado, simulamos um pensamento rápido
...
export async function buildAnswerStream(message, history = [], context = {}, onStep, attempt = 1) {
  ...
  try {
    ...
    // Aqui acionamos o orquestrador que agora GERA organicamente o raciocínio.
    ...
    return { 
        ...
        fontes: finalSources, 
        reasoning: runResult.reasoning, // Mantemos o raciocínio gerado organicamente pelo orquestrador
