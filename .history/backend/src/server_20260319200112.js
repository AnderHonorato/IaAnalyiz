...
import * as GoogleGenAIModule from '@google/genai'; // Importação robusta para ES Modules
...
app.post('/api/ia/chat', async (req, res) => {
  ...
  try {
    ...
    // CORREÇÃO DEFINITIVA: Instanciação a partir do namespace importado
    ...
    res.status(500).json({ reply: '⚠️ Falha no Kernel Neural.' });
  }
});
