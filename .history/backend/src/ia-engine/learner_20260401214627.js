...
function log(msg, type = 'info') {
  ...
  const level = { info: 'INFO', success: 'OK', warn: 'WARN', error: 'ERROR', study: 'STUDY', gemini: 'GEMINI' }[type] || 'INFO';
  console.log(`[learner.js] [${t}] [${level}] ${msg}`);
}

function banner() {
  console.log('[learner.js] IA ANALYIZ — SISTEMA DE APRENDIZADO (Autonomous Learning Active)');
}
