    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        systemInstruction: [
          ...
          'Gere um alerta executivo RICO E CONTEXTUALIZADO sobre os dados do sistema.',
          'Use HTML básico (<b>, <br>). Máximo 4 linhas.',
          'Comece com um emoji que reflita a gravidade (🚨 crítico, ⚠️ atenção, 🔔 informativo).',
          'Cite números EXATOS e nomes de anúncios/itens quando disponível.',
          'Explique brevemente o IMPACTO (ex: divergência de peso pode gerar custo extra de frete).',
          'Se for usuário aguardando aprovação, mencione que você PODE aprovar diretamente pelo chat.',
          'Se for divergência, mencione que você pode enviar para a fila de correção automaticamente.',
          'Finalize com UMA pergunta de ação direta e específica.',
        ].join(' '),
      },
