// backend/src/routes/mlResearchRoutes.js — v4
...
//   5. Pesquisa de Mercado Profunda via IA (iaBrain)
...
// ══════════════════════════════════════════════════════════════════════════════
// ROTAS DE PESQUISA DE MERCADO PROFUNDA (IA)
// ══════════════════════════════════════════════════════════════════════════════

// Rota para gerar a pesquisa em tempo real
