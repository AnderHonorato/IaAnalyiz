...
function salvarCaptura(mlbId, pagina, conteudo, debug) {
    try {
        ...
        debug.push(`  💾 HTML Capturado e salvo localmente`);
    } catch (e) {
              ...
              if (arr[0].components) {
                  ...
                  arr.forEach((o, index) => {
                      ...
                      vendedores.push({
                          ...
                          titulo: o.title || o.item?.title || 'Catálogo', freteGratis, envio, tipoAnuncio: tipo, vendas: vendasStr, parcelamento: parcelas,
                          pagina: paginaAtual, posicao: index + 1
                      });
                  });
              }
