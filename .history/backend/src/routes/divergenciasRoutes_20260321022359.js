// src/routes/divergenciasRoutes.js — com campo descrição no produto
...
// Rota especial: busca TODAS as divergências sem filtro de status (para o modal de envio em massa)
