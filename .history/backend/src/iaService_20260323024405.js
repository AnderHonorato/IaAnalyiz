// backend/src/iaService.js — Standalone Mode (Word-by-word local), Book Learning, ChatDocuments e Full Tools

import { GoogleGenAI } from '@google/genai';
import { PrismaClient } from '@prisma/client';
import crypto from 'crypto';
import { queryKnowledge, saveKnowledge } from './ia/brain/knowledge.js';
...
// ═══════════════════════════════════════════════════════════════════════════════
// FUNCTION CALLING (TOOLS) - TOTALMENTE COMPLETAS
// ═══════════════════════════════════════════════════════════════════════════════
