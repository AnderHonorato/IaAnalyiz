...
function geminiClient() {
  // Puxando a chave na hora da chamada para evitar cache
...
Seja técnico e direto.`;
    ...
    const result = await model.generateContent({
      ...
      tools: [{ googleSearch: {} }] // Ativa busca real do Google
    });
...
Retorne JSON: { "aprovada": boolean, "correcao": "texto corrigido ou null", "motivo": "string" }`;
    ...
    return { aprovada: true, correcao: null }; // Fallback seguro
  }
}
...
async function gerarEmbedding(texto) {
  ...
  try {
    ...
    // Trata tanto o formato antigo quanto o novo da SDK do Google Gen AI
