...
const GEMINI_EMBEDDING  = 'gemini-embedding-001'; // Modelo atualizado de vetorização
...
function extrairJSONSeguro(texto) {
  ...
  if (start === -1) throw new Error(`JSON não encontrado. Retorno cru da IA: ${texto.substring(0, 150)}...`);
...
// RESTAURADA A FUNÇÃO PARA NÃO QUEBRAR AS ROTAS
