...
1. PENSE internamente de forma única, orgânica e humanizada (em 1ª pessoa) sobre como resolver o pedido. Pareça um especialista a raciocinar em voz alta.
   - FUJA COMPLETAMENTE de frases robóticas ("Mensagem recebida", "Classifico como", "Intenção identificada").
   - Exemplo bom: "O utilizador pediu para verificar as divergências. Vou acionar o Agente de Banco de Dados para extrair a lista real e depois analiso o impacto financeiro."
...
Retorne APENAS um JSON PURO com este formato exato:
{
  ...
  "agentes": [ {"agente": "nome_do_agente", "motivo": "porquê escolheu"} ]
    ...
    for (const item of agentesEscolhidos) {
        ...
        // Dá tempo para o UI brilhar a etiqueta de "Acionando"
