...
// ─────────────────────────────────────────────────────────────────────────────
const IA_GIF = '../assets/gifolhos.gif'; // ← TROQUE AQUI
    ...
    <div style={{ position: 'relative', display: 'inline-flex', flexDirection: 'column', alignItems: 'flex-end', gap: '6px' }}>
      ...
      <button
        ...
        style={{
          ...
          borderRadius: '999px', border: 'none', background: BRAND, cursor: 'pointer',
          boxShadow: '0 4px 20px rgba(30,41,59,0.45)',
          width: hovered ? '160px' : '58px', height: '58px',
          transition: 'width 0.28s cubic-bezier(0.34,1.2,0.64,1)',
          padding: 0, position: 'relative',
        }}
      >
        {/* Label "Assistente" — aparece no hover */}
        <span style={{
          flex: 1, color: 'white', fontSize: '13px', fontWeight: 700,
        ...
        {/* Círculo com GIF */}
        <span style={{
          width: '58px', height: '58px', flexShrink: 0, order: 2,
          ...
          <img
            ...
            style={{
              ...
              objectFit: 'contain',
              // GIF para de animar quando não está em hover para economizar atenção visual
              // Se quiser sempre animando, remova as linhas de filter abaixo
              filter: hovered ? 'none' : 'brightness(0.9)',
              transition: 'filter 0.2s',
            }}
            onError={(e) => {
              // Fallback: se o GIF não carregar, mostra ícone SVG
