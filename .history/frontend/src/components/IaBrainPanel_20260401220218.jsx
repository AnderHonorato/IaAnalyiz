 ...
 * 
 * Propósito:
 * Painel de visualização do "cérebro" da IA com métricas em tempo real.
 * Exibe capacidades de aprendizagem, conhecimentos armazenados e análise de desempenho.
 * 
 * Responsabilidades:
 * - Exibir status de estudos e aprendizado da IA
 * - Mostrar base de conhecimento persistida
 * - Renderizar métricas de desempenho e confiança
 * - Atualizar dados em tempo real via polling
 * - Estilo terminal "hacker" com visual escuro
 * 
 * Características:
 * - Terminal escuro com dados em tempo real
 * - Seções colapsáveis de informações
 * - Indicadores visuais de status (OK/Erro/Aviso)
 * - Gráficos de tendência de desempenho
 * - Estatísticas de uso e acertos
 * 
 * Estado:
 *   - brainData: Dados do cérebro da IA
 *   - expanded: Seções expandidas/colapsadas
 *   - loading: Flag de carregamento
 * 
 * APIs:
 *   - GET /api/ia/brain - Dados do cérebro da IA
 *   - GET /api/ia/knowledge - Base de conhecimento
 * 
...
/** Formata tempo decorrido em linguagem natural */
