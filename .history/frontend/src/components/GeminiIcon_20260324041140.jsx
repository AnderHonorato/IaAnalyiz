...
export default function GeminiIcon({ size = 32, animating = false }) {
  ...
  const spDist       = size * 0.52;

  const sparkles = [
    { cls: 'sp0', x: half - spDist * 0.62, y: half - spDist * 0.62 },
    { cls: 'sp1', x: half + spDist * 0.55, y: half - spDist * 0.58 },
    { cls: 'sp2', x: half + spDist * 0.50, y: half + spDist * 0.65 },
    { cls: 'sp3', x: half - spDist * 0.58, y: half + spDist * 0.60 },
  ];
