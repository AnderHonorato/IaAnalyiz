 ...
 * 
 * Propósito:
 * Sistema completo de modais customizados que substitui confirm(), alert() nativo.
 * Fornece interface visual consistency com tema do projeto.
 * 
 * Responsabilidades:
 * - Gerenciar fila de modais
 * - Renderizar confirmações, alertas e diálogos
 * - Suportar diferentes tipos (danger, warning, success, info)
 * - Fornecer ícones e cores apropriadas
 * - Gerenciar estado e callbacks de resposta
 * 
 * Exports Principais:
 * - ModalProvider: Wrapper do aplicativo
 * - useModal(): Hook para acessar { confirm, alert, prompt }
 * 
 * Definições de Tipo:
 * - danger: Ações destrutivas (delete, logout)
 ...
 *   
 *   // Confirmação com risco
 *   if (await confirm({ 
 *     title: 'Excluir?', 
 *     message: 'Será removido permanentemente.',
 *     danger: true 
 *   })) {
 *     // Utilizador confirmou
 *   }
 *   
 *   // Alerta informativo
 *   await alert({ 
 ...
 * @version 1.0.0
 * @requires React, lucide-react, createContext, useContext
 */
...
/** Context para compartilhar funcionalidade de modal */
const ModalContext = createContext(null);

/** Hook para acessar funções de modal em qualquer componente */
...
/** Mapeamento de ícones e cores por tipo de modal */
const ICONS = {
