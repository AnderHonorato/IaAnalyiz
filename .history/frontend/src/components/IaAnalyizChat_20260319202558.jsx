...
// ─── Detecta intenção para montar os passos visuais ──────────────────────────
...
// ─── Ícone da IA — igual dentro e fora do chat ────────────────────────────────
...
export default function IaAnalyizChat({ isChatOpen, toggleChat, onLog, userRole }) {
  ...
  // ── Dimensões do chat ──────────────────────────────────────────────────────
  // Normal: 340×520, fixado no canto inferior direito
  // Expandido: ocupa até 90vw × 85vh mas não sai da tela
  ...
  return (
    <>
      ...
      {/* ── CHAT WINDOW ─────────────────────────────────────────────────────── */}
      {/* Renderiza sempre mas escala para 0 quando fechado — posição FIXA, não relativa à bolinha */}
      <div
      ...
      >
        ...
        <div className="bg-[#1e293b] px-4 py-3 flex justify-between items-center text-white shrink-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={toggleChat}
              className="hover:bg-red-500/20 p-2 rounded-xl transition-all"
              title="Fechar"
            >
              <X className="w-4 h-4" />
            </button>
        ...
        <div className="border-t border-slate-200 bg-white shrink-0">
          ...
          <div className="p-3 flex gap-2 items-end">
            <textarea
              ...
              rows={1}
              placeholder={isChatLoading ? 'Aguarde...' : 'Escreva para a IA... (Shift+Enter para quebrar linha)'}
      ...
      {/* ── BOTÃO FLUTUANTE ─────────────────────────────────────────────────── */}
      {/* Só aparece quando o chat está fechado */}
      <div
