...
function FloatingButton({ onClick, hasUnread }) {
  ...
  return (
    <div style={{ position: 'relative', display: 'inline-flex', flexDirection: 'column', alignItems: 'flex-end', gap: '6px' }}>
      ...
      >
        {/* Label "Assistente" — aparece no hover, à esquerda */}
        <span style={{
          flex: 1, color: 'white', fontSize: '13px', fontWeight: 700,
          whiteSpace: 'nowrap', paddingLeft: '18px', order: 1,
        ...
        {/* Círculo branco com GIF — sempre visível à direita */}
        <span style={{
          width: '62px', height: '62px', flexShrink: 0, order: 2,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          borderRadius: '50%', overflow: 'hidden',
          background: '#ffffff',
          boxShadow: 'inset 0 0 0 2px rgba(30,41,59,0.08)',
        }}>
          <img
            src={IA_GIF}
            alt="IA"
