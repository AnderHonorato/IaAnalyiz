    ...
    <div style={{ position: 'relative', display: 'inline-flex', flexDirection: 'column', alignItems: 'flex-end', gap: '6px' }}>
      ...
      <button
        ...
        style={{
          ...
          width: hovered ? '168px' : '62px', height: '62px',
          transition: 'width 0.28s cubic-bezier(0.34,1.2,0.64,1)',
          padding: 0, position: 'relative',
          outline: hovered ? `2px solid ${BRAND}` : '2px solid #e2e8f0',
        }}
      >
        {/* Label "Assistente" — aparece no hover */}
        <span style={{
          flex: 1, color: BRAND, fontSize: '13px', fontWeight: 700,
        ...
        {/* Círculo com GIF — fundo branco */}
        <span style={{
          width: '62px', height: '62px', flexShrink: 0, order: 2,
          ...
          />
          {/* Fallback SVG */}
          <span style={{ display: 'none', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', background: BRAND, borderRadius: '50%' }}>
