...
// Função super segura para obter o usuário do cache sem quebrar o JavaScript
const getSafeUser = () => {
  try {
...
export default function MainLayout() {
  ...
  // Trava de segurança para garantir que o split não quebre a página
  const primeiroNome = typeof user?.nome === 'string' ? user.nome.split(' ')[0] : 'Admin';
  ...
  return (
    <div className="h-screen w-full bg-[#f8fafc] flex flex-col font-sans text-slate-900 overflow-hidden relative">
      ...
      {/* ÁREA DINÂMICA ENVOLVIDA PELO ERROR BOUNDARY */}
      ...
      {/* CHAT BLINDADO PELO ERROR BOUNDARY */}
      <ErrorBoundary>
