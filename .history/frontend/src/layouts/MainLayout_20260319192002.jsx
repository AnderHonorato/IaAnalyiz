...
export default function MainLayout() {
  ...
  // Trava de segurança para não quebrar a tela se o user for null
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                <div className="flex flex-col text-right hidden sm:flex">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-widest text-blue-400 mt-0.5">Master Admin</span>
                </div>
