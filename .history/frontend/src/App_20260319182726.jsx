      ...
      <header className="bg-[#1e293b] border-b border-slate-700 p-4 shadow-xl shrink-0 z-30">
        <div className="w-full max-w-7xl mx-auto flex justify-between items-center text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* DROPDOWN DE ESCOLHER PLATAFORMA (GERENCIADO POR REACT STATE) */}
            <div className="relative" ref={platformMenuRef}>
              ...
              {/* Menu Flutuante (Abre com o clique) */}
              <div 
                className={`absolute top-full right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-slate-100 z-50 overflow-hidden text-slate-700 transition-all duration-200 transform origin-top ${isPlatformMenuOpen ? 'opacity-100 scale-100 pointer-events-auto' : 'opacity-0 scale-95 pointer-events-none'}`}
              >
