  ...
  return (
    <div className="h-screen w-full bg-[#f8fafc] flex flex-col font-sans text-slate-900 overflow-hidden relative" style={{ zoom: zoom }}>
      ...
      <style>{`
        ...
        .dropdown-menu { transform-origin: top; transition: all 0.2s ease-out; }
      `}</style>

      {/* HEADER FIXO CORPORATIVO COM DROPDOWN DE PLATAFORMAS */}
      <header className="bg-[#1e293b] border-b border-slate-700 p-4 shadow-xl shrink-0 z-30">
        <div className="w-full max-w-7xl mx-auto flex justify-between items-center text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* DROPDOWN DE ESCOLHER PLATAFORMA */}
            <div className="relative group">
              <button className="flex items-center gap-2 bg-slate-800 border border-slate-700 hover:bg-slate-700 text-slate-300 hover:text-white px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-sm">
                <span>Escolher Plataforma</span>
                <ChevronDown className="w-3.5 h-3.5 opacity-50 group-hover:opacity-100 transition-opacity" />
              </button>

              {/* Menu Flutuante Oculto (Aparece no Hover) */}
              <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-slate-100 opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto dropdown-menu z-50 overflow-hidden text-slate-700">
                <div className="p-3 text-[10px] font-black uppercase tracking-widest text-slate-400 bg-slate-50 border-b border-slate-100">
                  Selecione a Loja
                </div>
                
                <button 
                  onClick={() => setActiveMarketplace('ml')} 
                ...
                >
                  ...
                  {activeMarketplace === 'ml' && <span className="w-2 h-2 bg-blue-500 rounded-full"></span>}
                </button>
                ...
                >
                  ...
                  {activeMarketplace === 'shopee' && <span className="w-2 h-2 bg-blue-500 rounded-full"></span>}
                </button>

                <button 
                  onClick={() => setActiveMarketplace('amazon')} 
                ...
                >
                  ...
                  {activeMarketplace === 'amazon' && <span className="w-2 h-2 bg-blue-500 rounded-full"></span>}
                </button>
              </div>
            </div>
