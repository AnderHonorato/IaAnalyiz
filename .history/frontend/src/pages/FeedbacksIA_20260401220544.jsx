/**
 * frontend/src/pages/FeedbacksIA.jsx
 * 
 * Propósito:
 * Dashboard de análise de feedback dos utilizadores sobre as respostas da IA.
 * Exibe métricas de satisfação (thumbs up/down) e comentários.
 * Acesso restrito a OWNER.
 * 
 * Responsabilidades:
 * - Exibir estatísticas gerais de feedback
 * - Calcular taxa de aprovação da IA
 * - Listar feedbacks com comentários e contexto
 * - Filtrar e buscar feedbacks
 * - Exibir gráficos de tendência
 * - Identificar problemas recorrentes
 * 
 * Métricas Exibidas:
 *   - Total de avaliações
 *   - Feedback positivo (thumbs up)
 *   - Feedback negativo (thumbs down)
 *   - Taxa de aprovação (%)
 *   - Tendências temporais
 * 
 * Dados Capturados:
 *   - ID da mensagem
 *   - Tipo de feedback (positivo/negativo)
 *   - Comentário/motivo (opcional)
 *   - Timestamp
 *   - Mensagem original da IA
 *   - Contexto do chat
 * 
 * Funcionalidades:
 * - Visualização de estatísticas em cards
 * - Lista detalhada de feedbacks
 * - Filtro por período/data
 * - Busca por conteúdo
 * - Exportação de relatório
 * - Gráficos de aprovação ao longo do tempo
 * 
 * Estado:
 *   - data: { stats, feedbacks } - Dados da API
 *   - loading: Flag de carregamento
 *   - filtro: Filtro ativo
 *
 * APIs:
 *   - GET /api/ia/feedback - Feedback e estatísticas
 * 
 * Componentes Utilizados:
 *   - MessageSquareHeart: Ícone principal
 *   - ThumbsUp/ThumbsDown: Ícones de feedback
 * 
