...
export default function MLDashboard() {
  ...
  const ferramentas = [
    ...
    },
    {
      ...
      desc: 'Responde perguntas de compradores automaticamente.',
      icon: MessageCircle,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {ferramentas.map((tool) => (
            <div
              ...
              className={`bg-white p-5 rounded-3xl shadow-sm border border-slate-200 transition-all flex flex-col ${
                tool.active
