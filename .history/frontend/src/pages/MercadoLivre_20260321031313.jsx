...
// ══════════════════════════════════════════════════════════════════════════
function ModalDicas({ onClose, activeTab, onNavigate }) {
              ...
              <div className="flex gap-1.5 flex-wrap justify-center">
                {TOUR_STEPS.map((s, i) => (
                  <button key={s.id} onClick={() => setStepIdx(i)}
                    className={`w-8 h-8 rounded-full text-[9px] font-black border transition-all ${i===stepIdx?'bg-blue-600 text-white border-blue-600':'i<stepIdx?bg-emerald-50 text-emerald-600 border-emerald-200':'bg-slate-50 text-slate-400 border-slate-200'} ${i<stepIdx?'bg-emerald-50 text-emerald-600 border-emerald-200':''}`}>
                    {i<stepIdx?'✓':i+1}
                  </button>
                ))}
              </div>
