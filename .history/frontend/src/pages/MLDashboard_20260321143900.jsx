...
export default function MLDashboard() {
  ...
  const ferramentas = [
    ...
    },
    {
      ...
      icon: LayoutList,
      color: 'text-teal-600', bg: 'bg-teal-50', border: 'border-teal-200', accent: '#0d9488',
    ...
    },
    {
      ...
      icon: Search,
      color: 'text-violet-600', bg: 'bg-violet-50', border: 'border-violet-200', accent: '#7c3aed',
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-500"
                  title="Atualizar"
                >
