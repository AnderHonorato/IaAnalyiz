...
function extrairMLBId(input) {
  ...
  // URL com slug
  const urlMatch = raw.match(/\/[^/]+-MLB(\d+)/i);
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-3 py-2 flex flex-col" style={{ minHeight: '100vh' }}>
      ...
      <div className="flex gap-3 flex-1">
        ...
        {/* LOG TERMINAL */}
        {log.length > 0 && (
          <div className="w-72 flex-shrink-0 bg-slate-950 rounded-2xl p-3 flex flex-col" style={{ maxHeight: '70vh' }}>
            ...
            <div className="flex-1 overflow-y-auto space-y-0.5 font-mono">
              ...
              {rodando && (
                <div className="text-[9px] text-blue-400 flex items-center gap-1 animate-pulse">
