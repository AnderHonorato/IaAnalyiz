...
export default function AuthLayout({ children }) {
  return (
    <div className="min-h-screen w-full bg-[#0f172a] flex font-sans overflow-hidden">
      
      {/* LADO ESQUERDO: INFORMAÇÕES E BOAS VINDAS (Fixo na tela, Oculto no Mobile) */}
      <div className="hidden lg:flex flex-col justify-center w-1/2 p-12 xl:p-16 bg-slate-950 border-r border-slate-800 relative h-screen">
        ...
        <div className="relative z-10 max-w-lg mx-auto w-full">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              <div className="bg-slate-800 border border-slate-700 p-3 rounded-xl text-blue-400 mt-1 shadow-sm shrink-0"><Box className="w-5 h-5" /></div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="bg-slate-800 border border-slate-700 p-3 rounded-xl text-emerald-400 mt-1 shadow-sm shrink-0"><Sparkles className="w-5 h-5" /></div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="bg-slate-800 border border-slate-700 p-3 rounded-xl text-amber-400 mt-1 shadow-sm shrink-0"><ShieldCheck className="w-5 h-5" /></div>
              <div>
      ...
      {/* LADO DIREITO: FORMULÁRIOS COM SCROLL INDEPENDENTE */}
      {/* Aqui adicionamos h-screen, overflow-y-auto e padding no eixo Y para garantir que nunca corte. */}
      <div className="w-full lg:w-1/2 h-screen overflow-y-auto flex flex-col items-center custom-scrollbar relative">
        
        {/* Usamos my-auto e margens para ele centralizar na tela grande, mas permitir rolar se a tela for pequena */}
        <div className="bg-[#1e293b] p-8 sm:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-slate-700 relative z-10 my-auto mt-8 mb-8 shrink-0">
